...
impl<I: Send + 'static, O: Clone + Send + 'static> NodeConfig for Lambdaer<I, O> {
    fn into_runner(self: Box<Self>) -> Box<dyn NodeRunner + Send> {
        Box::new(LambdaerRunner {
